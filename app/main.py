...
app.include_router(api_endpoints.api_router)      # specific routes FIRST
app.include_router(api_endpoints.health_router)
app.include_router(main_router)


# Serve static assets
app.mount("/static/js", StaticFiles(directory="frontend/static/js"), name="js")
app.mount("/static/css", StaticFiles(directory="frontend/static/css"), name="css")
app.mount("/static/img", StaticFiles(directory="frontend/static/img"), name="img")
